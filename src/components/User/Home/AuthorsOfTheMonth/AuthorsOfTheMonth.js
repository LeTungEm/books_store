    ...
    return (
        <>
            ...
            <div className="flex flex-wrap justify-center gap-5 mt-20 px-10 lg:gap-16">
                <AuthorItem image={image} title={"Harry Potter"} description={"asndjsd asdjsad asdsd asdjsad asdsd asdjsad asdsd asdjsad asdsd"} />
                <AuthorItem image={image2} title={"Jean Snow"} description={"asndjsd asdjsad asdsd asdjsad asdsd asdjsad asdsd asdjsad asdsd"} />
                <AuthorItem image={image} title={"Peter Hause"} description={"asndjsd asdjsad asdsd asdjsad asdsd asdjsad asdsd asdjsad asdsd"} />
                <AuthorItem image={image2} title={"Amanda Sweet"} description={"asndjsd asdjsad asdsd asdjsad asdsd asdjsad asdsd asdjsad asdsd"} />
            </div>
        </>
    );
}
